...
public class ThreadDemoMine {
	 ...
	 * @param args
	 */
	public static void main(final String[] args) {//final damit in run() verwendbar -> immer auf dasselbe Objekt verweißt
		...
		new Thread(runnable).start();	//nicht run() damit Ausführung asynchron erfolgt
