...
/**
 * <p>This class models an HTTP application container. It does implement the acceptor/service
 * threading pattern, the HTTP 1.1 connection keep-alive feature, extended variable scopes
 * (including process-wide global scope), plug-in HTTP handler execution, plug-in handler
 * compilation, and request path mapping. Note that by default the resource "/default.html"
 * is used instead of "/", but can be re-mapped as well.</p>
 */
@TypeMetadata(copyright="2010-2013 Sascha Baumeister, all rights reserved", version="0.3.0", authors="Sascha Baumeister")
public final class HttpContainer1 extends HttpServer {
	 ...
	 */
	public HttpContainer1(final int servicePort, final Path contextPath, final Map<String,String> requestPathMappings) throws IOException {
	...
	public static void main(final String[] args) throws IOException {
		...
		try (HttpServer server = new HttpContainer1(servicePort, contextPath, requestPathMappings)) {
