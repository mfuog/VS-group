...
public class BinaryTransporter implements Runnable, Callable<Long> {
	...
	public Long call() throws IOException {
		...
		try {
			...
			/*Warum finally:	Was passiert wenn beim Schließen ein Fehler auftaucht?
			*					Man muss garantieren, dass jede Ressource die geöffnet wird, auch geschlossen wird, egal was passiert
